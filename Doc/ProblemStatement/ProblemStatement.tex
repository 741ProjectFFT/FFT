...
Put your problem statement here.  \wss{Why didn't you delete this line?}
...
$\mathcal{O}(n\log{}n)$ , where $\mathcal{}n$ is the data size. Because of this
algorithm decreasing the amount of calculation incredibly so that the FFT is
widely used in the digital signal processing, fast discrete Hartley transform
and etc.\\ \wss{You should just end your 
...
\wss{These lines about the comments should not be in your problem statement.
  They were only there as examples in the original file.}

\wss{Your lines of tex should be 80 characters long, ending with a hard return.
This will help with future diffs.}
