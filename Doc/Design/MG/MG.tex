...
\item[Services:] Outputs the results of the calculations, include the results of FFT based on the input datas. Verifies that the output results follow the FFT calculation algorithm. Throws a warning if the output data number not equals the input data number.
\item[Implemented By:] FFTL
\end{description} 
