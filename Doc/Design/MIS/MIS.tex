...
\section{MIS of Input  Module} \label{Input} \wss{Use labels for cross-referencing}
...
\section{MIS of Output  Module} \label{Input} \wss{Use labels for cross-referencing}
